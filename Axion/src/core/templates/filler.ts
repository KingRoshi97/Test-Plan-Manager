...
const HEADING_DOMAIN_MAP: Record<string, string[]> = {
  "architecture": ["software_architecture", "distributed_systems"],
  "security": ["security_fundamentals", "identity_and_access_management", "application_security"],
  "auth": ["identity_and_access_management", "authentication_and_sessions", "authorization_models"],
  "login": ["authentication_and_sessions", "identity_and_access_management"],
  "session": ["authentication_and_sessions"],
  "oauth": ["authentication_and_sessions", "identity_and_access_management"],
  "rbac": ["authorization_models", "identity_and_access_management"],
  "permission": ["identity_and_access_management", "authorization_models"],
  "data": ["relational_databases", "nosql_datastores", "storage_fundamentals"],
  "database": ["relational_databases", "sql_modeling_and_migrations", "nosql_datastores"],
  "sql": ["relational_databases", "sql_modeling_and_migrations", "postgresql"],
  "postgres": ["postgresql", "relational_databases", "sql_modeling_and_migrations"],
  "mysql": ["mysql_mariadb", "relational_databases"],
  "nosql": ["nosql_datastores", "document_databases", "key_value_stores"],
  "mongo": ["document_databases", "nosql_datastores"],
  "redis": ["key_value_stores", "caching_strategies"],
  "storage": ["object_storage", "storage_fundamentals"],
  "backup": ["backup_restore_and_dr"],
  "disaster": ["backup_restore_and_dr"],
  "recovery": ["backup_restore_and_dr"],
  "migration": ["sql_modeling_and_migrations"],
  "schema": ["sql_modeling_and_migrations", "relational_databases"],
  "api": ["api_design", "rest_apis", "api_observability"],
  "rest": ["rest_apis", "api_design"],
  "graphql": ["graphql", "api_design"],
  "grpc": ["grpc_and_rpc"],
  "rpc": ["grpc_and_rpc"],
  "webhook": ["webhooks_and_event_delivery"],
  "endpoint": ["api_design", "rest_apis"],
  "integration": ["api_design", "webhooks_and_event_delivery"],
  "rate": ["rate_limiting_and_abuse_controls"],
  "throttle": ["rate_limiting_and_abuse_controls"],
  "abuse": ["rate_limiting_and_abuse_controls"],
  "validation": ["input_validation_and_sanitization"],
  "sanitiz": ["input_validation_and_sanitization"],
  "input": ["input_validation_and_sanitization"],
  "queue": ["background_jobs_and_queues"],
  "job": ["background_jobs_and_queues"],
  "background": ["background_jobs_and_queues"],
  "worker": ["background_jobs_and_queues"],
  "event": ["webhooks_and_event_delivery", "event_streaming"],
  "stream": ["stream_processing", "event_streaming"],
  "feature": ["feature_flags_and_config"],
  "flag": ["feature_flags_and_config"],
  "config": ["feature_flags_and_config"],
  "test": ["testing_strategies", "quality_engineering"],
  "testing": ["testing_strategies", "quality_engineering"],
  "quality": ["quality_engineering", "testing_strategies"],
  "deploy": ["ci_cd", "release_engineering", "cloud_fundamentals"],
  "deployment": ["ci_cd", "release_engineering"],
  "cicd": ["ci_cd", "release_engineering"],
  "pipeline": ["ci_cd", "release_engineering"],
  "release": ["release_engineering", "ci_cd"],
  "monitor": ["monitoring_and_alerting", "observability_platform"],
  "monitoring": ["monitoring_and_alerting", "observability_platform"],
  "alert": ["monitoring_and_alerting", "incident_response"],
  "incident": ["incident_response", "monitoring_and_alerting"],
  "oncall": ["incident_response", "site_reliability_engineering"],
  "observ": ["observability_platform", "logging_and_tracing"],
  "log": ["logging_and_tracing", "observability_platform"],
  "logging": ["logging_and_tracing"],
  "trace": ["logging_and_tracing", "observability_platform"],
  "tracing": ["logging_and_tracing"],
  "slo": ["slo_sla_error_budgets", "site_reliability_engineering"],
  "sla": ["slo_sla_error_budgets"],
  "reliability": ["site_reliability_engineering", "slo_sla_error_budgets"],
  "uptime": ["site_reliability_engineering", "slo_sla_error_budgets"],
  "compliance": ["compliance_and_governance"],
  "governance": ["compliance_and_governance"],
  "audit": ["compliance_and_governance"],
  "regulation": ["compliance_and_governance"],
  "cache": ["caching_strategies"],
  "caching": ["caching_strategies"],
  "search": ["search_and_indexing"],
  "indexing": ["search_and_indexing"],
  "elasticsearch": ["search_and_indexing"],
  "error": ["observability_platform", "monitoring_and_alerting"],
  "performance": ["performance_and_scalability", "performance_frontend"],
  "scaling": ["performance_and_scalability", "capacity_planning"],
  "scale": ["performance_and_scalability", "capacity_planning"],
  "capacity": ["capacity_planning", "performance_and_scalability"],
  "accessibility": ["accessibility", "design_systems"],
  "a11y": ["accessibility"],
  "design": ["design_systems", "ui_architecture"],
  ...
  "k8s": ["kubernetes"],
  "infrastructure": ["infrastructure_as_code", "cloud_fundamentals"],
  "terraform": ["infrastructure_as_code"],
  "iac": ["infrastructure_as_code"],
  "cloud": ["cloud_fundamentals", "infrastructure_as_code"],
  "aws": ["cloud_fundamentals"],
  "azure": ["cloud_fundamentals"],
  "gcp": ["cloud_fundamentals"],
  "secret": ["secrets_and_config_platform", "cryptography_and_key_management"],
  "vault": ["secrets_and_config_platform"],
  "encrypt": ["cryptography_and_key_management"],
  "crypto": ["cryptography_and_key_management"],
  "certificate": ["cryptography_and_key_management"],
  "tls": ["cryptography_and_key_management", "networking_fundamentals"],
  "network": ["networking_fundamentals", "networking_cloud"],
  "dns": ["networking_fundamentals", "networking_cloud"],
  "tcp": ["networking_fundamentals", "internet_protocols"],
  "http": ["http_and_web_platform", "internet_protocols"],
  "websocket": ["http_and_web_platform"],
  "cors": ["http_and_web_platform", "application_security"],
  "load": ["load_balancing_and_edge"],
  "balancer": ["load_balancing_and_edge"],
  "cdn": ["load_balancing_and_edge"],
  "edge": ["load_balancing_and_edge"],
  "cost": ["cost_optimization"],
  "billing": ["cost_optimization", "payments"],
  "pricing": ["cost_optimization"],
  "mobile": ["mobile_engineering"],
  "ios": ["mobile_engineering"],
  "android": ["mobile_engineering"],
  "responsive": ["mobile_engineering", "web_frontend_engineering"],
  "frontend": ["web_frontend_engineering", "ui_architecture"],
  "react": ["web_frontend_engineering"],
  "vue": ["web_frontend_engineering"],
  "angular": ["web_frontend_engineering"],
  "nextjs": ["web_frontend_engineering"],
  "component": ["design_systems", "ui_architecture"],
  "i18n": ["internationalization"],
  "internationalization": ["internationalization"],
  "localization": ["internationalization"],
  "offline": ["offline_and_sync"],
  "sync": ["offline_and_sync"],
  "push": ["push_notifications"],
  "notification": ["push_notifications"],
  "machine": ["ml_engineering", "mlops"],
  "learning": ["ml_engineering", "mlops", "education"],
  "model": ["ml_engineering", "mlops"],
  "training": ["ml_engineering"],
  "inference": ["ml_engineering", "llm_applications"],
  "llm": ["llm_applications", "retrieval_and_rag"],
  "rag": ["retrieval_and_rag"],
  "embedding": ["retrieval_and_rag"],
  "vector": ["retrieval_and_rag"],
  "etl": ["etl_elt_pipelines", "data_engineering"],
  "warehouse": ["data_warehousing"],
  "lake": ["data_lakes_and_lakehouse"],
  "analytics": ["analytics_and_telemetry"],
  "telemetry": ["analytics_and_telemetry"],
  "metric": ["analytics_and_telemetry", "monitoring_and_alerting"],
  "dashboard": ["analytics_and_telemetry", "observability_platform"],
  "shell": ["shell_and_cli"],
  "cli": ["shell_and_cli"],
  "terminal": ["shell_and_cli"],
  "distributed": ["distributed_systems"],
  "microservice": ["distributed_systems", "service_mesh"],
  "mesh": ["service_mesh"],
  "platform": ["platform_engineering", "internal_developer_platforms"],
  "devtool": ["devtools"],
  "sdk": ["devtools"],
  "developer": ["devtools", "internal_developer_platforms"],
  "desktop": ["desktop_applications"],
  "healthcare": ["healthcare"],
  "patient": ["healthcare"],
  "clinical": ["healthcare"],
  "hipaa": ["healthcare", "compliance_and_governance"],
  "ehr": ["healthcare"],
  "finance": ["financial_services"],
  "financial": ["financial_services"],
  "banking": ["financial_services"],
  "trading": ["financial_services"],
  "fintech": ["financial_services", "payments"],
  "payment": ["payments"],
  "stripe": ["payments"],
  "checkout": ["payments", "ecommerce"],
  "transaction": ["payments", "financial_services"],
  "insurance": ["insurance"],
  "claims": ["insurance"],
  "underwriting": ["insurance"],
  "legal": ["legal_services"],
  "law": ["legal_services"],
  "contract": ["legal_services"],
  "education": ["education"],
  "lms": ["education"],
  "school": ["education"],
  "course": ["education"],
  "government": ["government_public_sector"],
  "civic": ["government_public_sector"],
  "public": ["government_public_sector"],
  "energy": ["energy_utilities"],
  "utility": ["energy_utilities"],
  "grid": ["energy_utilities"],
  "retail": ["retail"],
  "store": ["retail"],
  "inventory": ["retail", "logistics_supply_chain"],
  "pos": ["retail"],
  "ecommerce": ["ecommerce"],
  "cart": ["ecommerce"],
  "shop": ["ecommerce"],
  "catalog": ["ecommerce", "retail"],
  "logistics": ["logistics_supply_chain"],
  "shipping": ["logistics_supply_chain"],
  "supply": ["logistics_supply_chain"],
  "tracking": ["logistics_supply_chain"],
  ...
  "listing": ["real_estate", "marketplaces"],
  "hotel": ["hospitality_travel"],
  "travel": ["hospitality_travel"],
  "booking": ["hospitality_travel"],
  "reservation": ["hospitality_travel"],
  "food": ["food_and_beverage"],
  "restaurant": ["food_and_beverage"],
  "recipe": ["food_and_beverage"],
  "delivery": ["food_and_beverage", "logistics_supply_chain"],
  "music": ["music_and_audio"],
  "audio": ["music_and_audio"],
  "podcast": ["music_and_audio"],
  "video": ["film_and_video"],
  "film": ["film_and_video"],
  "media": ["film_and_video", "digital_publishing"],
  "gaming": ["gaming"],
  "game": ["gaming"],
  "publishing": ["digital_publishing"],
  "blog": ["digital_publishing"],
  "cms": ["digital_publishing"],
  "content": ["digital_publishing"],
  "saas": ["saas_b2b"],
  "b2b": ["saas_b2b"],
  "tenant": ["saas_b2b"],
  "multitenancy": ["saas_b2b"],
  ...
  "community": ["social_platforms"],
  "feed": ["social_platforms"],
  "chat": ["social_platforms"],
  "messaging": ["social_platforms"],
};
...
- When reference material is provided, apply its specific patterns, technologies, and standards to this project's context — cite specific approaches, thresholds, or implementation patterns from the material
...
- Do not reference KIDs, knowledge library identifiers, or cite sources by internal ID
- STRICTLY FORBIDDEN phrases (never write these under any circumstances): "to be determined", "to be defined", "to be filled", "as needed", "as appropriate", "will be defined later", "TBD", "N/A", "as required", "to be decided", "depending on requirements"
- Every statement must be concrete and specific to THIS project — name specific endpoints, data fields, components, technologies, or configuration values
- Each section MUST contain at least 3 actionable items: specific steps, requirements, decisions, or technical details
- If you genuinely cannot determine specifics, flag as an explicit unknown: "**UNKNOWN:** [What specific information is needed to resolve this]" — never leave it vague
- Keep each section substantive (100-300 words each) — depth over brevity
