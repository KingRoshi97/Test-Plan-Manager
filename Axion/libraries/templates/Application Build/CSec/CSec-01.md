# CSec-01 — Token Storage Policy (web/mobile, rotation)
...
| Applies           | All projects requiring token storage policy (web |
| Filled By         | Internal Agent                                   |
| Consumes          | ROUTE-03, ROUTE-06, CSec-01                      |
| Produces          | Filled Token Storage Policy (web/mobile, rotation|
...
1. `## Token Storage Policy (web/mobile, rotation)`
2. `## Configuration`
3. `## Dependencies`
