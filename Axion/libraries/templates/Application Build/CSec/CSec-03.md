# CSec-03 — Secure Communication (TLS, cert pinning, WS auth)
...
| Applies           | All projects requiring secure communication (tls |
| Filled By         | Internal Agent                                   |
| Consumes          | ROUTE-03, ROUTE-06, CSec-01                      |
| Produces          | Filled Secure Communication (TLS, cert pinning, W|
...
1. `## Secure Communication (TLS, cert pinning, WS auth)`
2. `## Configuration`
3. `## Dependencies`
