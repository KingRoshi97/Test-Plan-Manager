# CSec-02 — Input Sanitization Rules (XSS, injection)
...
| Applies           | All projects requiring input sanitization rules  |
| Filled By         | Internal Agent                                   |
| Consumes          | ROUTE-03, ROUTE-06, CSec-01                      |
| Produces          | Filled Input Sanitization Rules (XSS, injection) |
...
1. `## Input Sanitization Rules (XSS, injection)`
2. `## Configuration`
3. `## Dependencies`
