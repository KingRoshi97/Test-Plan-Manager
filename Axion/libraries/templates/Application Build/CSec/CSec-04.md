# CSec-04 — Sensitive Data Handling (PII masking, clipboard, screenshots)
...
| Applies           | All projects requiring sensitive data handling ( |
| Filled By         | Internal Agent                                   |
| Consumes          | ROUTE-03, ROUTE-06, CSec-01                      |
| Produces          | Filled Sensitive Data Handling (PII masking, clip|
...
1. `## Sensitive Data Handling (PII masking, clipboard, screenshots)`
2. `## Configuration`
3. `## Dependencies`
