# CER-05 — Graceful Degradation Rules (fallback UI, offline modes)
...
| Applies           | All projects requiring graceful degradation rule |
| Filled By         | Internal Agent                                   |
| Consumes          | ROUTE-03, ROUTE-06, CSec-01                      |
| Produces          | Filled Graceful Degradation Rules (fallback UI, o|
...
1. `## Graceful Degradation Rules (fallback UI, offline modes)`
2. `## Configuration`
3. `## Dependencies`
