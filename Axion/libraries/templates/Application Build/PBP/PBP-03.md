# PBP-03 — Web Budgets (Core Web Vitals)
...
| Applies           | All projects requiring web budgets (core web vitals)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Web Budgets (Core Web Vitals) Document                         |

## 2. Purpose

Define and document the web budgets (core web vitals) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Web Budgets (Core Web Vitals) Overview       | spec         | No              |
