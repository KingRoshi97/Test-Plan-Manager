# PBP-07 — Budget Reporting (dashboards, trends)
...
| Applies           | All projects requiring budget reporting (dashboards, trends)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Budget Reporting (dashboards, trends) Document                         |

## 2. Purpose

Define and document the budget reporting (dashboards, trends) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Budget Reporting (dashboards, trends) Overview       | spec         | No              |
