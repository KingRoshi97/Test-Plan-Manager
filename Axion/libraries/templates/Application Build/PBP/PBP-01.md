...
| Applies           | All projects requiring performance budgets overview (web/mobile/api)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Performance Budgets Overview (web/mobile/api) Document                         |

## 2. Purpose

Define and document the performance budgets overview (web/mobile/api) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Performance Budgets Overview (web/mobile/api) Overview       | spec         | No              |
