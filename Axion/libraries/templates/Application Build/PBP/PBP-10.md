# PBP-10 — Budget Change Control (who can change thresholds)
...
| Applies           | All projects requiring budget change control (who can change thresholds)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Budget Change Control (who can change thresholds) Document                         |

## 2. Purpose

Define and document the budget change control (who can change thresholds) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Budget Change Control (who can change thresholds) Overview       | spec         | No              |
