# PBP-06 — Perf CI Gates (bundle size, CWV, API p95)
...
| Applies           | All projects requiring perf ci gates (bundle size, cwv, api p95)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Perf CI Gates (bundle size, CWV, API p95) Document                         |

## 2. Purpose

Define and document the perf ci gates (bundle size, cwv, api p95) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Perf CI Gates (bundle size, CWV, API p95) Overview       | spec         | No              |
