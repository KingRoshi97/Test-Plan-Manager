# PBP-08 — Budget Exceptions & Waivers (temporary overrides)
...
| Applies           | All projects requiring budget exceptions & waivers (temporary overrides)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Budget Exceptions & Waivers (temporary overrides) Document                         |

## 2. Purpose

Define and document the budget exceptions & waivers (temporary overrides) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Budget Exceptions & Waivers (temporary overrides) Overview       | spec         | No              |
