...
| Applies           | All projects requiring asset loading strategy (code split, lazy load)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Asset Loading Strategy (code split, lazy load) Document                         |

## 2. Purpose

Define and document the asset loading strategy (code split, lazy load) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Asset Loading Strategy (code split, lazy load) Overview       | spec         | No              |
