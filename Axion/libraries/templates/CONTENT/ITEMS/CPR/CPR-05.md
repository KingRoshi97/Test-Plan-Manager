...
| Applies           | All projects requiring perf regression gates (thresholds, ci checks)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Perf Regression Gates (thresholds, CI checks) Document                         |

## 2. Purpose

Define and document the perf regression gates (thresholds, ci checks) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Perf Regression Gates (thresholds, CI checks) Overview       | spec         | No              |
