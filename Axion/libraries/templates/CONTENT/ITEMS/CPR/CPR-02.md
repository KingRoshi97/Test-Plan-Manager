...
| Applies           | All projects requiring rendering strategy (ssr/csr, list virtualization)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Rendering Strategy (SSR/CSR, list virtualization) Document                         |

## 2. Purpose

Define and document the rendering strategy (ssr/csr, list virtualization) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Rendering Strategy (SSR/CSR, list virtualization) Overview       | spec         | No              |
