...
| Field             | Value                                              |
|-------------------|----------------------------------------------------|
| Template ID       | A11YD-05                                             |
| Template Type     | Design / Accessibility                                            |
| Template Version  | 1.0.0                                              |
| Applies           | All projects requiring accessible error messaging      |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Accessible Error Messaging Document                           |
...
|---------------------------|--------------|-----------------|
| Accessible Error Messaging Overview         | spec         | No              |
