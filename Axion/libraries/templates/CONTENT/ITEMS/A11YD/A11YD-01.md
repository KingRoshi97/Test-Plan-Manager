...
| Field             | Value                                              |
|-------------------|----------------------------------------------------|
| Template ID       | A11YD-01                                             |
| Template Type     | Design / Accessibility                                            |
| Template Version  | 1.0.0                                              |
| Applies           | All projects requiring accessibility requirements checklist (wcag-aligned)      |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Accessibility Requirements Checklist (WCAG-aligned) Document                           |
...
|---------------------------|--------------|-----------------|
| Accessibility Requirements Checklist (WCAG-aligned) Overview         | spec         | No              |
