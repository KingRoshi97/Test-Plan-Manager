...
| Field             | Value                                              |
|-------------------|----------------------------------------------------|
| Template ID       | A11YD-02                                             |
| Template Type     | Design / Accessibility                                            |
| Template Version  | 1.0.0                                              |
| Applies           | All projects requiring keyboard/focus order spec      |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Keyboard/Focus Order Spec Document                           |
...
|---------------------------|--------------|-----------------|
| Keyboard/Focus Order Spec Overview         | spec         | No              |
