...
| Applies           | All projects requiring versioning & change management (breaking changes, deprecation)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Versioning & Change Management (breaking changes, deprecation) Document                         |
