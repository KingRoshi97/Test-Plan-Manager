...
| Applies           | All projects requiring failure handling (lockouts, partial provision, retries)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Failure Handling (lockouts, partial provision, retries) Document                         |
...
5. `## Retry Rules`
6. `## Lockout Rules`
7. `## Partial Provisioning`
8. `## Account Linking Conflicts`
9. `## Session Loop Prevention`
10. `## Telemetry`
