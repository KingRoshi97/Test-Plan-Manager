# YD-02 — Keyboard/Focus Order Spec
...
Define and document the keyboard/focus order spec for the project. This template establishes the authoritative specification that downstream documents reference.
