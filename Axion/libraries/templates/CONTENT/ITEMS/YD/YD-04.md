...
| Applies           | All projects requiring color contrast & visual    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Color Contrast & Visual Document                         |

## 2. Purpose

Define and document the color contrast & visual for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Color Contrast & Visual Overview       | spec         | No              |
