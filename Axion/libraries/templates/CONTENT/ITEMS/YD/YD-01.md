# YD-01 — Accessibility Requirements
...
| Applies           | All projects requiring accessibility requirements    |
...
Define and document the accessibility requirements for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Accessibility Requirements Overview       | spec         | No              |
