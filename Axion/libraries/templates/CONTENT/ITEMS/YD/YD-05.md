# YD-05 — Accessible Error Messaging
...
Define and document the accessible error messaging for the project. This template establishes the authoritative specification that downstream documents reference.
