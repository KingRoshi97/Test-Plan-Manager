# PBP-04 — API Budgets (latency/error budgets per endpoint class)
...
|-------------------|----------------------------------------------------|
| Template ID       | PBP-04                                             |
| Template Type     | Build / Playbook Patterns                                          |
| Template Version  | 1.0.0                                              |
| Applies           | All projects requiring api budgets (latency/error budgets per endpoint class)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled API Budgets (latency/error budgets per endpoint class) Document                         |

## 2. Purpose

Define and document the api budgets (latency/error budgets per endpoint class) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| API Budgets (latency/error budgets per endpoint class) Overview       | spec         | No              |
...
- **Downstream**: Related Application Build templates
