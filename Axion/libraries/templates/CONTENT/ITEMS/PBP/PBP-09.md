# PBP-09 — Bundle Size & Asset Budgets (web/mobile)
...
| Applies           | All projects requiring bundle size & asset budgets (web/mobile)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Bundle Size & Asset Budgets (web/mobile) Document                         |

## 2. Purpose

Define and document the bundle size & asset budgets (web/mobile) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Bundle Size & Asset Budgets (web/mobile) Overview       | spec         | No              |
