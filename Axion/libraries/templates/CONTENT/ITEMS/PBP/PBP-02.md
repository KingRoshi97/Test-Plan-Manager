# PBP-02 — Budget Registry (by budget_id)
...
| Applies           | All projects requiring budget registry (by budget_id)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Budget Registry (by budget_id) Document                         |

## 2. Purpose

Define and document the budget registry (by budget_id) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Budget Registry (by budget_id) Overview       | spec         | No              |
