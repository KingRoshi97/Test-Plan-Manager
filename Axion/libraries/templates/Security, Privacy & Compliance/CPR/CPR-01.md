...
| Applies           | All projects requiring performance budget (web + mobile targets)    |
| Filled By         | Internal Agent                                     |
| Consumes          | Canonical Spec, Intake Submission, Standards Snapshot |
| Produces          | Filled Performance Budget (web + mobile targets) Document                         |

## 2. Purpose

Define and document the performance budget (web + mobile targets) for the project. This template establishes the authoritative specification that downstream documents reference.
...
|---------------------------|--------------|-----------------|
| Performance Budget (web + mobile targets) Overview       | spec         | No              |
