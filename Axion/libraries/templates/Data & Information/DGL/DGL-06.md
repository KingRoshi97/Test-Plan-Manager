...
Data Quality & Validation (DQV
Data Quality & Validation (DQV)​
DQV-01 Validation Policy (schema vs semantic)​
DQV-02 Data Quality Checks Catalog (rules by entity)​
DQV-03 Input Validation Rules (API/forms → entities)​
DQV-04 Consistency & Integrity Monitoring (drift, anomalies)​
DQV-05 Bad Data Handling (quarantine, repair, backfill)​
DQV-06 DQ Test & Verification Plan
