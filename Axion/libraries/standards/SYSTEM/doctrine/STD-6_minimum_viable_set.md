...
- SYSTEM/contracts/standards_pack.v1.schema.json
- SYSTEM/contracts/standards_index_entry.v1.schema.json
- SYSTEM/contracts/standards_index.v1.schema.json
- SYSTEM/contracts/standards_snapshot.v1.schema.json
- SYSTEM/contracts/standards_conflict.v1.schema.json (optional)

### 3) Registries (runtime defaults) — located in SYSTEM/registries/
- SYSTEM/registries/standards_index.v1.json
- packs/<pack files referenced by index> (at least one pack for testing)
- SYSTEM/registries/standards_resolver_version.v1.json (optional, if you pin resolver version explicitly)

### 4) Gate specs (optional) — located in SYSTEM/contracts/
- SYSTEM/contracts/STD-5_standards_gates.spec.json
