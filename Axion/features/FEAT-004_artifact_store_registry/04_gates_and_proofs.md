# FEAT-004 — Artifact Store & Registry: Gates & Proofs
...
|------------|------|---------------|
| P-01 | Command Output Proof | CAS put/get round-trip verification |
| P-02 | Test Result Proof | Unit test results for CAS, refs, GC |
