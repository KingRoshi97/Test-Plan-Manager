# FEAT-013 — Ref Integrity Engine: Error Codes
  ...
  |------|----------|---------|-----------|--------|
  | `ERR-REF-001` | error | Ref Integrity Engine initialization failed | false | Check configuration and dependencies. |
| `ERR-REF-002` | error | Ref Integrity Engine invalid input | false | Validate input against schema before passing. |
| `ERR-REF-003` | warning | Ref Integrity Engine degraded operation | false | Review logs for root cause. |
