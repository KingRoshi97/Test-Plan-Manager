# FEAT-009 — Export Bundles: Error Codes
  ...
  |------|----------|---------|-----------|--------|
  | `ERR-KIT-001` | error | Export Bundles initialization failed | false | Check configuration and dependencies. |
| `ERR-KIT-002` | error | Export Bundles invalid input | false | Validate input against schema before passing. |
| `ERR-KIT-003` | warning | Export Bundles degraded operation | false | Review logs for root cause. |
