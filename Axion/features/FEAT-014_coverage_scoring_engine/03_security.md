# FEAT-014 — Coverage Scoring Engine: Security Requirements
  ...
  Security requirements specific to the Coverage Scoring Engine feature domain.

  ## 2. Security Requirements

  - Coverage reports do not expose sensitive proof content
- Scoring rules are immutable during a run
