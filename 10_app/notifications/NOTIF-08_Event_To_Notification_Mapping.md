...
| Field | Value |
|---|---|
| template_id | NOTIF-08 |
| title | Event-to-Notification Mapping (events → messages) |
| type | notifications_event_to_message_mapping |
| template_version | 1.0.0 |
| output_path | 10_app/notifications/NOTIF-08_Event_To_Notification_Mapping.md |
| compliance_gate_id | TMP-05.PRIMARY.NOTIF |
| upstream_dependencies | ["EVT-01", "NOTIF-01", "NOTIF-03"] |
| inputs_required | ["SPEC_INDEX", "DOMAIN_MAP", "GLOSSARY", "STANDARDS_INDEX", "EVT-01", "EVT-02", "NOTIF-01", "NOTIF-03", "FFCFG-01"] |
