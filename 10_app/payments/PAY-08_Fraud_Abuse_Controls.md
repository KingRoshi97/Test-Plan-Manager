...
|---|---|
| template_id | PAY-08 |
| title | Fraud & Abuse Controls (risk checks, velocity limits) |
| type | payments_fraud_abuse_controls |
| template_version | 1.0.0 |
| output_path | 10_app/payments/PAY-08_Fraud_Abuse_Controls.md |
| compliance_gate_id | TMP-05.PRIMARY.PAY |
| upstream_dependencies | ["PAY-02", "RLIM-03", "RLIM-04", "ADMIN-02"] |
| inputs_required | ["SPEC_INDEX", "DOMAIN_MAP", "GLOSSARY", "STANDARDS_INDEX", "PAY-01", "PAY-02", "PAY-04", "RLIM-03", "RLIM-04", "FFCFG-01", "ADMIN-02"] |
