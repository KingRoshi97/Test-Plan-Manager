...
|---|---|
| template_id | PAY-03 |
| title | Pricing & Plan Mapping (plans, tiers, entitlements) |
| type | payments_pricing_plan_mapping |
| template_version | 1.0.0 |
| output_path | 10_app/payments/PAY-03_Pricing_Plan_Mapping.md |
| compliance_gate_id | TMP-05.PRIMARY.PAY |
| upstream_dependencies | ["PRD-06", "FFCFG-01", "API-04"] |
| inputs_required | ["SPEC_INDEX", "DOMAIN_MAP", "GLOSSARY", "STANDARDS_INDEX", "PRD-06", "PAY-01", "FFCFG-01", "API-04"] |
