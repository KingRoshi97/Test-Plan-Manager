...
|---|---|
| template_id | FMS-03 |
| title | Media Processing Integration (transcode/resize/scan vendors) |
| type | files_media_processing_integration |
| template_version | 1.0.0 |
| output_path | 10_app/files_media/FMS-03_Media_Processing_Integration.md |
| compliance_gate_id | TMP-05.PRIMARY.FMS |
| upstream_dependencies | ["FPMP-03", "FPMP-04", "FMS-01", "JBS-02"] |
| inputs_required | ["SPEC_INDEX", "DOMAIN_MAP", "GLOSSARY", "STANDARDS_INDEX", "FMS-01", "FPMP-03", "FPMP-04", "FPMP-06", "JBS-01", "JBS-02", "EVT-01"] |
