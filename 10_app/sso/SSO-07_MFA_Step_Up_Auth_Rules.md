...
|---|---|
| template_id | SSO-07 |
| title | MFA/Step-Up Auth Rules (when required) |
| type | sso_mfa_step_up_rules |
| template_version | 1.0.0 |
| output_path | 10_app/sso/SSO-07_MFA_Step_Up_Auth_Rules.md |
| compliance_gate_id | TMP-05.PRIMARY.SSO |
| upstream_dependencies | ["SSO-02", "API-04", "ADMIN-01"] |
| inputs_required | ["SPEC_INDEX", "DOMAIN_MAP", "GLOSSARY", "STANDARDS_INDEX", "SSO-01", "SSO-02", "API-04", "ADMIN-01", "ROUTE-04"] |
