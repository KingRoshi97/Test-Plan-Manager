...
| Field | Value |
|---|---|
| template_id | CRMERP-02 |
| title | Object/Entity Mapping Catalog (objects ↔ entities, keys) |
| type | crmerp_object_entity_mapping_catalog |
| template_version | 1.0.0 |
| output_path | 10_app/crmerp/CRMERP-02_Object_Entity_Mapping_Catalog.md |
| compliance_gate_id | TMP-05.PRIMARY.CRMERP |
| upstream_dependencies | ["CRMERP-01", "IXS-05", "DATA-06"] |
| inputs_required | ["SPEC_INDEX", "DOMAIN_MAP", "GLOSSARY", "STANDARDS_INDEX", "CRMERP-01", "IXS-05", "DATA-06", "DQV-03"] |
