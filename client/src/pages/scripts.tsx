...
const scripts: Script[] = [
  ...
  {
    name: "package (.mjs)",
    file: "axion/scripts/axion-package.mjs",
    description:
      "Bundles AXION outputs into distributable Agent Kit zip files. Supports different modes (docs, scaffold, full) and includes a manifest and agent prompt. Creates domain-based zip bundles.",
    icon: Package,
    tag: "Distribution",
    type: "pipeline",
    flags: ["--domain", "--dry-run", "--force"],
    usage: "node axion/scripts/axion-package.mjs --domain auth",
